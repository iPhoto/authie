...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if([[RODItemStore sharedStore].authie.handle.name isEqualToString:self.thread.toHandle.name]) {
        ...
        self.labelRequestDetails.text = [NSString stringWithFormat:@"You have received an authorization request from %@. If you accept this request %@ will be able to send you snaps and see snaps you've sent to the dash.", self.thread.fromHandleId, self.thread.fromHandleId];
